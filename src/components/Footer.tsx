        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://discord.gg/aniroll" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-theme-primary focus-visible:text-theme-primary transition">
              ...
              <a href="https://twitter.com/aniroll" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-theme-primary focus-visible:text-theme-primary transition">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              <a href="https://github.com/aniroll" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-theme-primary focus-visible:text-theme-primary transition">
